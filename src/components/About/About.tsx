...
const About = forwardRef<HTMLElement>((_,ref) => {
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        ...
        if (entry.isIntersecting) {
          entry.target.classList.add(element.dataset.animate || '');
        } else {
          entry.target.classList.remove(element.dataset.animate || '');
        }
      });
    }, { threshold: 0.1 });
  ...
  return (
    <section className='aboutMain' ref={ref}>
      <div className='aboutMain_components'>
        ...
        <div className='rightSection'>
          ...
          <p className='p p2'>
            I began my journey as a web developer in August 2024, and since then, I've continued to learn and challenge myself by taking on new challenges and learning the latest technologies along the way. I'm currently 19 years of age and I make beautiful UI from designs using modern technologies like ReactJs, TypeScript, Tailwindcss, Scss and much more.
          </p>
          <p className='p p3'>
