    ...
    return(
        ...
        <section className='projectMain'>
            <div className='projectMain_components'>
                <p className='p'>My <strong>Projects <svg className='stick' width="" height="" viewBox="0 0 10 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                <motion.path initial={{pathLength:0}} whileInView={{pathLength:1}} transition={{duration:1.25}} d="M5.02308 5.9752C3.79173 -3.87554 4.01599 25.813 4.01599 35.7404C4.01599 43.8531 4.01599 51.9658 4.01599 60.0785C4.01599 65.238 4.77634 60.8517 6.03017 58.344" stroke="#FFC000" stroke-width="7" stroke-linecap="round"/>
                </svg>
