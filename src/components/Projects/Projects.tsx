    ...
    return(
        ...
        <section className='projectMain'>
            <div className='projectMain_components'>
                ...
                <motion.path ref={stickRef} data-animation={'stickAnimate'} d="M5.02308 5.9752C3.79173 -3.87554 4.01599 25.813 4.01599 35.7404C4.01599 43.8531 4.01599 51.9658 4.01599 60.0785C4.01599 65.238 4.77634 60.8517 6.03017 58.344" stroke="#FFC000" stroke-width="7" stroke-linecap="round"/>
                </svg>
